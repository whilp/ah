...
- narrow `$(ah_lua)` to just library+sys/tools sources (exclude test .lua and bin/ah.lua) to allow more test parallelism — each test currently waits for ALL other test compilations
